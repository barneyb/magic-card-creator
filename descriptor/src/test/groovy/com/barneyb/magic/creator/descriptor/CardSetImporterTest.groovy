...
class CardSetImporterTest {
    ...
    void allInOne() {
        ...
        assertEquals(null, c.rarity)
        assertEquals(null, c.flavorText)
        assertEquals(null, c.cardNumber)
        ...
        assertEquals(false, c.semiEnchantment)
        assertEquals(null, c.setCardCount)
        assertEquals(null, c.setTitle)
        assertEquals(null, c.setKey)
        assertEquals(null, c.subtypeParts)
